...
import qualified Debian.Debianize.DebInfo as T (flags)
...
import qualified Debian.Debianize.Types.Atoms as T (Atoms, debInfo, extraLibMap, missingDependencies, packageDescription, packageInfo, PackageInfo(PackageInfo, cabalName, devDeb, docDeb, profDeb))
