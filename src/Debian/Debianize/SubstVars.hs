...
import qualified Debian.Debianize.Atoms as T (Atoms, debInfo, extraLibMap, missingDependencies, packageDescription, packageInfo, PackageInfo(PackageInfo, cabalName, devDeb, docDeb, profDeb))
