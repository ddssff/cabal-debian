...
import qualified Debian.Debianize.Types.Atoms as A (Atom, Atom(..), atomSet, debInfo, debInfo, InstallFile(execName, sourceDir), rulesHead, rulesIncludes, rulesSettings, showAtoms)
