...
import Debian.Debianize.DebInfo (changelog, compat, control, copyright, DebInfo, file, flags, install, installCabalExec, installCabalExecTo, installData, installDir, installInit, installTo, intermediateFiles, link, logrotateStanza, postInst, postRm, preInst, preRm, rulesFragments, rulesHead, rulesIncludes, rulesSettings, sourceFormat, warning, watch)
import Debian.Debianize.Prelude (listElemLens, maybeLens)
import Debian.Debianize.Types.Atoms (apacheSite, backups, buildDir, comments, debianNameMap, debVersion, epochMap, execMap, executable, extraDevDeps, extraLibMap, maintainerOption, missingDependencies, noDocumentationLibrary, noProfilingLibrary, official, omitLTDeps, omitProfVersionDeps, overrideDebianNameBase, packageDescription, packageInfo, revision, serverInfo, sourceArchitectures, sourcePackageName, uploadersOption, utilsPackageNameBase, website, xDescription)
